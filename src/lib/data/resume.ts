...
export let DATA = {
	...
	description:
		'Full Stack Engineer turned Entrepreneur. I love building things and helping people !',
	summary:
		'Full Stack Engineer turned Entrepreneur. I love building things and helping people !',
	...
	contact: {
		...
		social: {
			...
			LinkedIn: {
				name: 'LinkedIn',
				url: 'https://www.linkedin.com/in/dalyll-reguia/',
				// // icon: Icons.linkedin,
				icon: LinkedinSvg,
				navbar: true,
	...
	work: [
		{
			company: 'Elyade',
			href: 'https://elyade.com',
			badges: [],
			location: 'Saint Jean, France',
	...
	education: [
		{
			...
			href: 'https://ynov.com',
			degree: 'Master in Computer Science (full stack engineer)',
